...
Diese Logfiles werden von GitHub bzw. dessen CDN-Anbieter Fastly im Rahmen des Betriebs von GitHub Pages verarbeitet. Angaben zur Speicherdauer findest du in der [GitHub Privacy Statement](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement).

---

## 4. Hosting

Diese Website wird als statische Seite über **GitHub Pages** ausgeliefert, ein Angebot der GitHub, Inc., 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA (für Nutzer in der EU: GitHub B.V., Prins Bernhardplein 200, 1097 JB Amsterdam, Niederlande). Die Auslieferung erfolgt über ein weltweit verteiltes Content-Delivery-Network (Fastly), wodurch Daten auch außerhalb der EU, unter anderem in den USA, verarbeitet werden können.

Bei einem Datentransfer in die USA stützt sich GitHub auf die EU-Standardvertragsklauseln (SCC) als geeignete Garantie im Sinne von Art. 46 DSGVO. Details zur Datenverarbeitung durch GitHub findest du in der [GitHub Privacy Statement](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement).
...
_Zuletzt aktualisiert: 19. Juli 2026_
	</div>
</article>
